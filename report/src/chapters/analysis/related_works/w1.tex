...
Schema enforcement methods such as constrained decoding \cite{anderson2017guided}, schema-guided prompting \cite{zhang2023sgptod}, and external validation help ensure that LLM outputs adhere to predefined structures. 
...
Chen et al.~\cite{le2025automated} &
\raisebox{-0.1cm}{\tikz[baseline]{\filldraw[fill=black]
(0,0) -- (90:0.4cm) arc (90:-150:0.4cm) -- cycle; \draw (0,0) circle (0.4cm);}} &
\raisebox{-0.1cm}{\tikz[baseline]{\filldraw[fill=black]
(0,0) -- (90:0.4cm) arc (90:-150:0.4cm) -- cycle; \draw (0,0) circle (0.4cm);}} &
