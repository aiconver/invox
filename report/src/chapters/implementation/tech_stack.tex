...
Authentication and authorization are handled by \textbf{Keycloak}, which supports OAuth2 and OpenID Connect \cite{rfc6749,openid_connect}. Role-based policies ensure that only authorized users can submit, review, or modify templates, supporting secure multi-user workflows.
